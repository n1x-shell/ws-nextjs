...
export const QUEST_REGISTRY: Record<string, Quest> = {
  ...
  q002_mara_scrap: {
    ...
    rewards: { xp: 75, creds: 20, items: ['broken_servo'] },
    repeatable: true,
    prerequisites: [],
    levelRequirement: 1,
  },
  ...
  q004_renovation: {
    ...
    rewards: { xp: 120, creds: 25, items: ['signal_wire'] },
    repeatable: false,
    prerequisites: [],
    levelRequirement: 4,
  },
  q005_shipment: {
    ...
    rewards: { xp: 150, creds: 40, items: ['seized_medical_supplies'] },
    repeatable: false,
    prerequisites: [],
    levelRequirement: 5,
  },
  q006_supply_line: {
    ...
    rewards: { xp: 125, creds: 30, items: ['tunnel_map_deep'] },
    repeatable: false,
  ...
  q007_maintenance_override: {
    ...
    rewards: { xp: 250, creds: 60, items: ['helixion_override_codes'] },
    repeatable: false,
    prerequisites: [],
    levelRequirement: 7,
  },
  ...
  q009_first_steps: {
    ...
    rewards: { xp: 80, creds: 15, items: ['scavenger_map_fragment'] },
    repeatable: false,
    prerequisites: [],
    levelRequirement: 1,
  },
  ...
  q013_verification: {
    ...
    rewards: { xp: 200, creds: 50, items: ['cache_key'] },
    repeatable: false,
    prerequisites: [],
    levelRequirement: 4,
  },
  ...
  q014_prove_it: {
    ...
    rewards: { xp: 150, creds: 40, items: ['intact_t1_cyberware'] },
    repeatable: false,
    prerequisites: [],
    levelRequirement: 5,
  },
  q015_fence_line: {
    ...
    rewards: { xp: 250, creds: 60, items: ['wolf_territory_marker'] },
    repeatable: false,
  ...
  q018_foremans_exit: {
    ...
    rewards: { xp: 300, creds: 75, items: ['helixion_comms_log'] },
    repeatable: false,
  ...
  q019_manifest_discrepancy: {
    ...
    rewards: { xp: 175, creds: 50, items: ['patrol_route_chip'] },
    repeatable: false,
    prerequisites: [],
    levelRequirement: 5,
  },
  q020_clean_harbor: {
    ...
    rewards: { xp: 125, creds: 40, items: ['comms_earpiece'] },
    repeatable: false,
    prerequisites: [],
    levelRequirement: 5,
  },
  q021_fresh_meat: {
    ...
    rewards: { xp: 200, creds: 60, items: ['fight_pit_token'] },
    repeatable: false,
    prerequisites: [],
    levelRequirement: 5,
  },
  ...
  q023_clean: {
    ...
    rewards: { xp: 125, creds: 30, items: ['neural_compound'] },
    repeatable: false,
  ...
  q024_eyes_everywhere: {
    ...
    rewards: { xp: 150, creds: 40, items: ['monitoring_device'] },
    repeatable: false,
    prerequisites: [],
    levelRequirement: 5,
  },
  q025_real_seeds: {
    ...
    rewards: { xp: 125, creds: 25, items: ['heirloom_seeds'] },
    repeatable: false,
    prerequisites: [],
    levelRequirement: 5,
  },
  q026_source_material: {
    ...
    rewards: { xp: 175, creds: 40, items: ['recording_device'] },
    repeatable: false,
    prerequisites: [],
    levelRequirement: 6,
  },
  ...
  q028_surplus: {
    ...
    rewards: { xp: 175, creds: 45, items: ['squad_tactical_data'] },
    repeatable: false,
    prerequisites: [],
    levelRequirement: 7,
  },
  q029_the_count: {
    ...
    rewards: { xp: 250, creds: 60, items: ['voss_deployment_sigil', 'wolf_augment_schematic'] },
    repeatable: false,
  ...
  q031_purification: {
    ...
    rewards: { xp: 300, creds: 70, items: ['treatment_filter'] },
    repeatable: false,
    prerequisites: [],
    levelRequirement: 8,
  },
  q032_upstream: {
    ...
    rewards: { xp: 150, creds: 35, items: ['chemical_sample_kit'] },
    repeatable: false,
    prerequisites: [],
    levelRequirement: 7,
  },
  ...
  q034_the_ladder: {
    ...
    rewards: { xp: 400, creds: 100, items: ['chrome_knuckles'] },
    repeatable: false,
    prerequisites: [],
    levelRequirement: 6,
  },
  q035_the_fix: {
    ...
    rewards: { xp: 200, creds: 50, items: ['d9_field_report'] },
    repeatable: false,
    prerequisites: [],
    levelRequirement: 7,
  },
  q036_the_old_way: {
    ...
    rewards: { xp: 175, creds: 30, items: ['targeting_lens'] },
    repeatable: false,
    prerequisites: [],
    levelRequirement: 8,
  },
  q037_champions_story: {
    ...
    rewards: { xp: 250, creds: 60, items: ['corroded_data_chip'] },
    repeatable: false,
  ...
  q038_house_business: {
    ...
    rewards: { xp: 250, creds: 70, items: ['mesh_sniffer'] },
    repeatable: false,
    prerequisites: [],
    levelRequirement: 8,
  },
  q039_beast_problem: {
    ...
    rewards: { xp: 175, creds: 40, items: ['rat_king_fragment'] },
    repeatable: false,
    prerequisites: [],
    levelRequirement: 7,
  },
  q040_pit_instinct: {
    ...
    rewards: { xp: 500, creds: 100, items: ['fenrirs_tooth'] },
    repeatable: false,
  ...
  q041_dead_drop: {
    ...
    rewards: { xp: 300, creds: 80, items: ['chrysalis_research_files'] },
    repeatable: false,
    prerequisites: [],
    levelRequirement: 13,
  },
  ...
  q043_kill_switch: {
    ...
    rewards: { xp: 500, creds: 100, items: ['the_leash_broken'] },
    repeatable: false,
  ...
  q045_frequency_rights: {
    ...
    rewards: { xp: 175, creds: 45, items: ['signal_jammer_personal'], factionRep: { THE_SIGNAL: 15 } },
    repeatable: false,
    prerequisites: [],
    levelRequirement: 8,
  },
  ...
  q048_signal_war: {
    ...
    rewards: { xp: 200, creds: 50, items: ['surveillance_hardware'], factionRep: { THE_SIGNAL: 20 } },
    repeatable: false,
    prerequisites: [],
    levelRequirement: 9,
  },
  ...
  q057_the_way_back: {
    ...
    rewards: { xp: 175, creds: 40, items: ['substrate_growth_sample'] },
    repeatable: false,
    prerequisites: [],
    levelRequirement: 9,
  },
  ...
  q051_prove_clean: {
    ...
    rewards: { xp: 125, creds: 25, items: ['grid_map'] },
    repeatable: false,
    prerequisites: [],
    levelRequirement: 3,
  },
  ...
  q058_supply_run: {
    ...
    rewards: { xp: 200, creds: 50, items: ['neural_calibration_kit'] },
    repeatable: false,
    prerequisites: [],
    levelRequirement: 10,
  },
  ...
  q061_the_picture: {
    ...
    rewards: { xp: 450, creds: 100, items: ['broadcast_specs'] },
    repeatable: false,
    prerequisites: [],
    levelRequirement: 13,
  },
  q062_direct_option: {
    ...
    rewards: { xp: 400, creds: 75, items: ['neutralizing_compound_coil'] },
    repeatable: false,
    prerequisites: [],
    levelRequirement: 12,
  },
  q063_the_bridge: {
    ...
    rewards: { xp: 1000, creds: 0, items: ['counter_frequency_generator'] },
    repeatable: false,
  ...
  q064_market_correction: {
    ...
    rewards: { xp: 200, creds: 50, items: ['compliance_stim'] },
    repeatable: false,
    prerequisites: [],
    levelRequirement: 10,
  },
  ...
  q066_the_bypass: {
    ...
    rewards: { xp: 125, creds: 10, items: ['neural_shunt_fragment'] },
    repeatable: false,
    prerequisites: [],
    levelRequirement: 10,
  },
  ...
  // q069 — reserved (cut during quest chain revision)
  q070_dwells_return: {
    ...
    rewards: { xp: 300, creds: 50, items: ['substrate_attunement_stone'] },
    repeatable: false,
    prerequisites: [],
    levelRequirement: 0,
  },
  ...
  q071_the_bridge_deploy: {
    ...
    rewards: { xp: 1500, creds: 0, items: ['the_frequency_key'] },
    repeatable: false,
    prerequisites: ['q063_the_bridge'],
    levelRequirement: 15,
  },
  q072_the_answer_deploy: {
    ...
    rewards: { xp: 2000, creds: 0, items: ['substrate_resonance_crystal', 'the_frequency_key'] },
    repeatable: false,
  ...
  q075_lab_nightmare: {
    ...
    rewards: { xp: 4000, creds: 600, items: ['overwrite_neural_core', 'sovereign_frequency_implant'] },
    repeatable: true,
